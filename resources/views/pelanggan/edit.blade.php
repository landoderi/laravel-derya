                    ...
                    <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                value="{{ $pelanggan->nama }}" placeholder="Nama pelanggan" required>
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nipd') is-invalid @enderror" name="nipd"
                                value="{{ $pelanggan->nipd }}" placeholder="alamat" required>
                            @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp"
                                value="{{ $pelanggan->nipd }}" placeholder="No hp" required>
                            @error('no_hp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
